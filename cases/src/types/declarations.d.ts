...
declare module "component/Table" {
  ...
  interface TableProps {
    ...
    onCheckboxChange?: (rowData: any, isChecked: boolean) => void;
...
interface CreateTaskActivityProps {
  Description: string;
  TaskConfigurationProcess: string;
  PortalUser: string;
  Due: string | Date;
  SLA: string;
  SLAStatus?: string;
...
interface ActivityPageNumSizeProps {
  PageNumber: Number;
  PageSize: Number;
  Query?: string;
}
...
declare module "component/CustomDateTimePicker";
